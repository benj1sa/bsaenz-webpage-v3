...
export function WritingPost({ title, date, image, slug }: WritingPostProps) {
  const content = (
    <section className="group cursor-pointer">
      ...
      <div className="w-full aspect-video bg-gray-100 rounded overflow-hidden transition duration-200 group-hover:opacity-70 cursor-pointer">
        {image ? (
          ...
          <div className="w-full h-full bg-linear-to-br from-orange-200 via-blue-200 to-green-200 flex items-center justify-center transition duration-200 group-hover:opacity-90 cursor-pointer">
